 ...
 */
public class DrawDominoRepeatFragment extends DialogFragment
{
    public interface DrawListener
    {
        public void drawAgainCallback(Domino added);
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState)
    {
        ...
        builder.setPositiveButton("Add", new DialogInterface.OnClickListener()
        {
            ...
            {
                //Add domino to hand
                mListener.drawAgainCallback(new Domino(var1, var2));
            }
        })
