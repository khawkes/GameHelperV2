 ...
 */
public class LetterSelectFragment extends DialogFragment
{
    ...
    int numColumns;
    int deckMax;
    LetterSelectListener mListener;
    GridView gridView;
    View drawView;
    Display display;
    ...
    public void onAttach(Activity activity)
    {
        ...
        try
        {
            mListener = (LetterSelectListener) activity;
        }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState)
    {
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            ...
            {
                //mark value
                mListener.callbackLetterSelect(new ScrabbleLetter((char) (position + 'a')));
                dismiss();
            }
        });
