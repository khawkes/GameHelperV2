 ...
 */
public class LetterSelectRepeatFragment extends DialogFragment
{

    public interface LetterSelectRepeatListener
    {
    ...
    int numColumns;
    int deckMax;
    LetterSelectRepeatListener mListener;
    GridView gridView;
    View drawView;
    Display display;
    ...
    public void onAttach(Activity activity)
    {
        ...
        try
        {
            mListener = (LetterSelectRepeatListener) activity;
        }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState)
    {
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            ...
            {
                //mark value
                mListener.callbackLetterRepeatSelect(new ScrabbleLetter((char) (position + 'a')));
                dismiss();
            }
        });
        ...
        builder.setTitle(R.string.letterSelectTitle);
